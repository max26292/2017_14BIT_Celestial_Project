<?php
					    ...
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        <!-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> -->
									<button type="button" class="btn btn-primary" onclick="test('<?php echo $row['product_id']; ?>');" data-dismiss="modal">Thêm vào giỏ hàng</button>
	...
	function delete_product_ordered($pro_id,$order_id)
	{
		$query = 'delete from orders where orders_id="'.$order_id.'" and product_id="'.$pro_id.'"';
		require ('connect.php');
		$conn->query($query);
		$conn->close();
	}
	
	function sum_orders($trans_id)
	{
		$query = 'SELECT SUM(orders_amount) as sum FROM orders WHERE trans_id ="'.$trans_id.'"';
		require ('connect.php');
		$data=$conn->query($query);
